    ...
    <el-dialog
      ...
      <el-form ref="dataForm" :model="formData" :rules="formRules">
        <el-form-item label="父ID" prop="pid">
          <el-select v-model="formData.pid" placeholder="顶级">
            <el-option
              ...
              :label="item.title"
              :value="item.id">
              <span style="float: left"><span v-html="item.html"/>{{ item.title }}</span>
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="规则名" prop="name">
          <el-input v-model="formData.name" type="" auto-complete="off"/>
        </el-form-item>
        <el-form-item label="规则标题" prop="title">
          <el-input v-model="formData.title" type="" auto-complete="off"/>
        </el-form-item>
        ...
        <el-form-item label="额外的规则表达式">
          <el-input v-model="formData.condition" type="textarea"/>
        </el-form-item>
